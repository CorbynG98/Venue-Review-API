...
exports.get = function (values, done) {
    ...
    let query = `SELECT Venue.venue_id as venueId, venue_name as venueName, category_id as categoryId, city, short_description as shortDescription, latitude, longitude, AVG(star_rating) as meanStartRating, AVG(mode_cost_rating) as modeCostRating, ${primaryPhoto} as primaryPhoto ${values[0]} ` +
        ` FROM Venue` +
