...
exports.getOne = function(user_id, done) {
    db.getPool().query("SELECT username, email, given_name as givenName, family_name as familyName, profile_photo_filename as photo FROM User WHERE user_id = ?;", user_id, function(err, rows) {
